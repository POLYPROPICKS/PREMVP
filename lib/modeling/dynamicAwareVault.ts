...
export function replayDynamicHarvest(candidates: readonly DynamicExecutionCandidate[], policy: Exclude<DynamicAwarePolicy, {
    ...
    settle(at);
    const batch: DynamicExecutionCandidate[] = [];
