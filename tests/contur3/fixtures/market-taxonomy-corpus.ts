...
export const TAXONOMY_CORPUS: TaxonomyCorpusCase[] = [
  ...
  { text: "Upminster to win the match?", expected: "allowed_fullmatch_moneyline" },
  { text: "Mpata to win the match?", expected: "allowed_fullmatch_moneyline" },
  { text: "LGD Gaming to win the series?", expected: "allowed_fullmatch_moneyline" },
  ...
  { text: "Team A to win -2.5 spread", expected: "allowed_fullmatch_spread", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "Team A to win +2.5 spread", expected: "allowed_fullmatch_spread", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "Team A to win 2.5 spread", expected: "allowed_fullmatch_spread", monitorDivergence: "allowed_fullmatch_moneyline" },
  // ── Allowed full-match total ──────────────────────────────────────────
  { text: "Total goals over 2.5", expected: "allowed_fullmatch_total" },
  { text: "Team A vs Team B — Full Match Total Over 2.5", expected: "allowed_fullmatch_total" },
  { text: "Total Runs Over 150.5", expected: "allowed_fullmatch_total" },
  { text: "Total Wickets Over 12.5", expected: "allowed_fullmatch_total" },
  ...
  { text: "LGD Gaming to win 2-0?", expected: "forbidden_exact_score", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "LGD Gaming to win 2-1?", expected: "forbidden_exact_score", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "Team A to win 3-0?", expected: "forbidden_exact_score", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "Team A to win 2:0?", expected: "forbidden_exact_score", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "Team A wins 2–0?", expected: "forbidden_exact_score", monitorDivergence: "unknown" },
  ...
  { text: "Toss Match Double Upminster Winner", expected: "forbidden_props", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "Most Sixes Upminster Winner", expected: "forbidden_props", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "Team Top Batter Upminster Winner", expected: "forbidden_props", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "Top Bowler Team A Winner", expected: "forbidden_props", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "Most Fours Team A Winner", expected: "forbidden_props", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "Man of the Match Winner", expected: "forbidden_props", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "Toss Winner", expected: "forbidden_props", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "Highest Opening Partnership Winner", expected: "forbidden_props", monitorDivergence: "allowed_fullmatch_moneyline" },
  { text: "Race to 50 Runs Winner", expected: "forbidden_props", monitorDivergence: "allowed_fullmatch_moneyline" },
  ...
  { text: "Group A Winner", expected: "forbidden_futures", monitorDivergence: "allowed_fullmatch_moneyline" },
