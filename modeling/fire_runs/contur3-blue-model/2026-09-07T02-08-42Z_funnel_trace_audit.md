...
**Generated:** 2026-09-07T02:08:42.750Z
**Lookback:** 336h (since 2026-08-24T02:08:42.750Z)
**Lookahead:** 1h (until 2026-09-07T03:08:42.750Z)
...
**Root cause stage:** `QUEUE_SENT_ORDER_MISSING`

**Why:** 12 real order event(s) exist but 0 live_confirmed — orders attempted but not confirmed. Check Ireland order logs.

**Next operator action:** Inspect Ireland executor logs for order failure reason. Check market status on Polymarket.
...
| queue_ready_count | 0 |
| queue_claimed_count | 68 |
| queue_sent_count | 0 |
| orders_real_count | 12 |
...
Stage `QUEUE_SENT_ORDER_MISSING` is the first stage where the funnel is blocked.



---

## Future Reservations (next 1h)
...
**Inspect Ireland executor logs for order failure reason. Check market status on Polymarket.**
