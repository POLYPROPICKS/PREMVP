...
**Review A2 closed:** the 671-terminal architect aggregate is discarded as non-authoritative because its query and selected-identity list were never preserved. `CANONICAL_RECONCILIATION_P50_52.md` records the exact reproducible runner path yielding 1015 selected / 716 terminal / 299 OPEN / +131.79u. There is no remaining modeling question about which aggregate governs the backfill. No runner code change is proposed or needed.
