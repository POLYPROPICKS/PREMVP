-- sql_id: market_family_coverage_v1
-- purpose: Market family coverage and ROI diagnostics
-- source_tables: public.generated_signal_pairs
-- output_grain: market family summary row
-- expected_columns: market_family,rows,fixtures,pnl,roi,winrate
-- no_db_writes: true
-- version: 1.0.0
...
select 'market_family_coverage_v1' as sql_id;
