-- sql_id: unresolved_candidate_audit_v1
-- purpose: Unresolved candidate count and exclusions
...
-- expected_columns: dataset_id,unresolved_count,missing_price,missing_result,missing_token,missing_condition
-- no_db_writes: true
-- version: 1.0.0
...
select 'unresolved_candidate_audit_v1' as sql_id;
