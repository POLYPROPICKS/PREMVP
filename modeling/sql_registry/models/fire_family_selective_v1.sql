-- sql_id: fire_family_selective_v1
-- purpose: Family selective shadow model
-- source_tables: public.generated_signal_pairs
-- output_grain: family-filtered selected candidate
-- expected_columns: model_id,market_family,fixture_key,condition_id,selected_token_id,pnl
-- no_db_writes: true
-- version: 1.0.0
...
select 'fire_family_selective_v1' as sql_id;
