...
An independent architect DB cross-check reported P50_52 combined N=1016, terminal=671, unresolved=345, reference PnL ~+122.89u, terminal ROI ~+18.31%, MaxDD ~-13.55u; P50_54 combined N=1225, terminal=824, unresolved=401, reference PnL ~+144.65u, terminal ROI ~+17.55%, MaxDD ~-12.65u. The canonical repaired-runner output above (P50_52 combined N=${P50_52_FOOTBALL.COMBINED.N}, terminal=${P50_52_FOOTBALL.COMBINED.TERMINAL_N}, unresolved=${P50_52_FOOTBALL.COMBINED.UNRESOLVED_N}; P50_54 combined N=${P50_54_FOOTBALL.COMBINED.N}, terminal=${P50_54_FOOTBALL.COMBINED.TERMINAL_N}, unresolved=${P50_54_FOOTBALL.COMBINED.UNRESOLVED_N}) is the authority for this note — N matches within 1-2 events, but **the runner shows MORE terminal and FEWER unresolved than the independent cross-check** (corrected direction; an earlier draft of this note stated the opposite by mistake).
